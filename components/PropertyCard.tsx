...
import { Favorite, FavoriteBorder, Bed, Bathtub, SquareFoot, Lock, Public } from '@mui/icons-material';
 ...
 */
const PropertyCard: React.FC<PropertyCardProps> = memo(({ property, compact = false }) => {
