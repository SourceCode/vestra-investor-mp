...
import { Paper, Typography, Grid, Card, CardContent, Switch, Button } from '@mui/material';
import { LocationOn, Add } from '@mui/icons-material';
import { useDispatch, useSelector } from 'react-redux';
import { RootState, fetchMarketsRequest } from '../../store';

const MarketsPage: React.FC = () => {
    const dispatch = useDispatch();
    const { markets, loading } = useSelector((state: RootState) => state.organization);
