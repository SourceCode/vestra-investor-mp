...
import { Paper, Typography, Grid, Button, LinearProgress, Chip } from '@mui/material';
import { EmojiEvents, History, CardGiftcard } from '@mui/icons-material';
import { useDispatch, useSelector } from 'react-redux';
import { RootState, fetchRewardsRequest, redeemRewardRequest } from '../../store';
import { useToast } from '../../contexts/ToastContext';

const LoyaltyPage: React.FC = () => {
    const dispatch = useDispatch();
    const { pointsBalance, history, catalog, loading } = useSelector((state: RootState) => state.rewards);
