...
import { Grid, Typography, Paper, Button, List, ListItem, ListItemText, Chip, Divider, IconButton } from '@mui/material';
import { Add, Assignment, MonetizationOn, People, MoreVert, CheckCircleOutline, WarningAmber } from '@mui/icons-material';
import { useSelector, useDispatch } from 'react-redux';
import { RootState, fetchDashboardRequest } from '../../store';
import { useNavigate } from 'react-router-dom';

const KPI = ({ label, value, icon, color }: { label: string, value: number, icon: React.ReactNode, color: string }) => (
...
const AgentDashboard: React.FC = () => {
    ...
    const { metrics, tasks, loading } = useSelector((state: RootState) => state.agent);
