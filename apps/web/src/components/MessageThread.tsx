...
import { fetchMessagesRequest, RootState, sendMessageRequest } from '../store';
...
const MessageThread: React.FC<MessageThreadProps> = ({ conversationId }) => {
    ...
    const { conversations, messagesByConversation } = useSelector((state: RootState) => state.messaging);
    ...
    const handleSend = () => {
        ...
        dispatch(sendMessageRequest({ body: newMessage, conversationId }));
        setNewMessage('');
    };
            ...
            <div className="p-4 bg-white border-t border-slate-200 shrink-0">
                <div className="flex gap-2 items-end">
                    ...
                    <TextField 
                        ...
                        sx={{ 
                            '& .MuiOutlinedInput-root': { backgroundColor: '#f8fafc', borderRadius: 3 } 
                        }}
                    />
                    <IconButton 
                        color="primary" 
