...
import { Avatar, Button, Chip, Drawer, IconButton, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from '@mui/material';
import React, { useEffect, useState } from 'react';
import { useDispatch, useSelector } from 'react-redux';

import { fetchInvestorsRequest, RootState, unlockInvestorRequest } from '../../store';
    ...
    return (
        <div>
            ...
            <Drawer 
                ...
                PaperProps={{ sx: { width: { sm: 400, xs: '100%' } } }}
            >
                {selectedInvestor && (
                    <div className="h-full flex flex-col">
                        <div className="p-6 bg-slate-900 text-white">
                            <div className="flex justify-between items-start mb-4">
                                <Avatar sx={{ bgcolor: 'primary.light', height: 64, width: 64 }}>{selectedInvestor.firstName[0]}</Avatar>
