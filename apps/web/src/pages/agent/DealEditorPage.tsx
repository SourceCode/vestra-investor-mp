import { ArrowBack, Public, Publish, Save, Share } from '@mui/icons-material';
import { Alert, Box, Button, Chip, Divider, FormControlLabel, Grid, InputAdornment, MenuItem, Paper, Switch, Tab, Tabs, TextField, Typography } from '@mui/material';
import React, { useEffect, useState } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { useNavigate, useParams } from 'react-router-dom';

import { useToast } from '../../contexts/ToastContext';
import { fetchPropertyDetail, RootState } from '../../store';
...
const DealEditorPage: React.FC = () => {
    ...
    const [formData, setFormData] = useState<any>({
        address: '', baths: 0, beds: 0, city: '', description: '', distribution: { referralFeeType: 'PERCENTAGE', referralFeeValue: 2.5, sharedToNetwork: false, visibleToOrgs: [] }, price: 0, sqft: 0, state: '',
        zip: ''
    });
