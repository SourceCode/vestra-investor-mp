import { ArrowBack, ArrowForward, MonetizationOn } from '@mui/icons-material';
...
import { fetchReferralsRequest, RootState } from '../../store';

const AgentReferralsPage: React.FC = () => {
    const dispatch = useDispatch();
    const { loading, referrals } = useSelector((state: RootState) => state.agent);
