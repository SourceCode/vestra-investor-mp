import { Add, Edit, FilterList, MoreVert, Search, Visibility } from '@mui/icons-material';
import { Button, Chip, IconButton, InputAdornment, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, Typography } from '@mui/material';
import React, { useEffect, useState } from 'react';
import { useDispatch, useSelector } from 'react-redux';
import { useNavigate } from 'react-router-dom';

import DealStatusChip from '../../components/DealStatusChip';
import { fetchProperties, RootState } from '../../store';
